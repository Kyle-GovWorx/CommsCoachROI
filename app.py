...
# Build inputs/results dicts (cheap, always needed for display)
inputs = {
...
# Excel and PDF are generated on demand to avoid blocking the UI on every rerender
