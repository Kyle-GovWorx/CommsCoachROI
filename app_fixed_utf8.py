...
# ----------------------------
# Product summaries (shown based on selected modules)
# ----------------------------
MODULE_SUMMARIES = {
    "QA": {
        "title": "CommsCoach QA",
        "body": (
            "Annual subscription for the single agency named on the order form. Includes: "
    ...
    "TRAIN": {
        ...
        "body": (
            "Annual subscription for the single agency named on the order form. Includes: "
            "AI-driven training simulations created from actual events in agency CAD and audio, a simulations library, "
            "and tools to create your own. Phased Training Templates, Task Lists, Automated Evaluations "
            "(when connected to QA), Observation Summaries, Dashboards, Reports, and Trainer Feedback. "
            "Observations can include and summarize evaluations performed over events."
        ),
    },
    "HIRE": {
        "title": "CommsCoach HIRE",
        "body": (
            "Annual subscription for the single agency named on the order form. Provides pre-hire candidate assessments "
    ...
    "ASSIST": {
        ...
        "body": (
            "Annual subscription for the single agency named on the order form. Provides real-time call transcription "
            "and translation to telecommunicators with in-call guidance and evaluations, and can notify others based on "
...
with cols[0]:
    ...
    st.markdown("**What you are getting:** Select the modules in the sidebar to view an included-features summary below the savings breakdown.")
with cols[1]:
    st.markdown(
        """
...
with left:
    ...
    st.subheader("Included with your subscription")
